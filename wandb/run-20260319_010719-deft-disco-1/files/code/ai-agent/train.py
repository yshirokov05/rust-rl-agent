...
def wait_for_server(host="127.0.0.1", port=28082):
...
class SimpleLogCallback(CheckpointCallback):
    ...
    def _on_step(self) -> bool:
        ...
        # Every 1000 steps: flush the GIF + print harvest_rate to console
...
def train():
    ...
    batch_size = 128  # Scaled down from 256 for VRAM emergency
